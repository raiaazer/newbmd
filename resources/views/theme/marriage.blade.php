...
<div class="container" style="margin-top: 10px;">
    <div class="row">
        <div class="col-md-6">
            <h1>Certified Marriage Copy</h1>
            <img src="{{asset('assets\images\Certified-Marriage-Copy.gif')}}" width="500px" height="540px">
        </div>
        <div class="col-md-6">
    ...
    <form method="POST" action="{{route('submit-form')}}">
        <input type="hidden" value="marriage" name="certificate_type">
		@csrf
        <div class="row">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
				<h3 style="background-color: purple;" class="text-white p-15">
					<strong>Details of the Marriage/Civil Partnership</strong>
				</h3>
			</div>
            <div class="col-sm-6">
                <label class="custom_label">DATE OF MARRIAGE</label>
                <input type="text" name="d_o_marriage" class="form-control datepicker" data-format="dd mm yyyy">
            </div>
            <div class="col-sm-6">
                <label class="custom_label">PLACE OF MARRIAGE</label>
                <input type="text" class="form-control" name="marriage_place">
            </div>
            <div class="col-sm-12">
                <label class="custom_label p-top">NAME OF THE HUSBAND</label>
            </div>
            <div class="col-sm-6">
                <label class="">Husband's First Name(s)</label>
                <input type="text" class="form-control" name="first_name">
            </div>
            <div class="col-sm-6">
                <label class="">Husband's Surname</label>
                <input type="text" class="form-control" name="last_name">
            </div>
            <div class="col-sm-12">
                <label class="custom_label p-top">NAME OF THE WIFE</label>
            </div>
            <div class="col-sm-6">
                <label class="">Wife's First Name(s)</label>
                <input type="text" class="form-control" name="wife_first_name">
            </div>
            <div class="col-sm-6">
                <label class="">Wife's Surname</label>
            ...
            <div class="col-sm-12">
                ...
                <input type="checkbox" value="1" class="" name="document_legalize">
                <h4>Subtotal</h4>
                <h4>£79.00</h4>
                <br>
                <h4>Options</h4>
