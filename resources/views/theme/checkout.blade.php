...
<div class="container" style="margin-top: 10px;">
    ...
    <div class="row">
        <div class="col-md-6">
        {{--  <form method="POST" name="form1" action="{{ route('submit-details') }}">  --}}
        <form method="POST" action="{!! URL::route('paypal') !!}">

        <input type="hidden" value="amount" name="120">
        <input type="hidden" value="transaction" name="transaction_id">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4 mar-top">
                ...
                <select class="form-control" name="bill_country">heading
                    @if(!$data==null)
                    @foreach($data as $d)
            ...
            <div class="col-sm-6 mar-top">
                ...
                <input type="text" name="bill_postcode" class="form-control">
            </div>
            <div class="col-sm-6 mar-top">
        ...
        <div class="row ship" style="display: none">
            ...
            <div class="col-sm-6">
                <label class="custom_label">Last Name</label>
                <input type="text" name="ship_last_name" class="form-control">
            </div>
            <div class="col-sm-12 mar-top">
                <label class="custom_label">Company name (optional)</label>
            ...
            <div class="form-group col-sm-4 mar-top">
                ...
                <select class="form-control" name="ship_country">heading
                    @if(!$data==null)
                    @foreach($data as $d)
                    <option value="{{$d->id}}">{{$d->name}}</option>
                    @endforeach
            ...
            <div class="col-sm-6 mar-top">
                ...
                <input type="text" name="ship_postcode" class="form-control">
            </div>
            <div class="col-sm-6 mar-top">
            ...
            <div class="col-sm-6 mar-top">
                ...
                <br>
                <textarea class="form-control" name="ship_order_notes" id="" cols="30" rows="4"></textarea>
            </div>
        </div>
        </div>
        <div class="col-md-6">
